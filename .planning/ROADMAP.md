...
- [x] 02-01-PLAN.md — Валидационный каркас Wave 0: расширение check-tokens (bp-группа, media-query сверка, transition-grep, W1-ассерт, grep-использование, 0 script), новый check-contrast, negative-фикстура theme, verify-цепочка
- [x] 02-02-PLAN.md — Решения фазы: hex палитры проектов (D-07) + выбор концепта первого экрана (R9) (2 чекпоинта)
...
- [x] 02-05-PLAN.md — work.astro SYSTEM DEMO (grep-usage) + docs/hero-concept.md (R9) + первый полный зелёный verify

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 02-06-PLAN.md — Финальный гейт: verify + CI зелёный + визуальный проход 320/375/768/1200 (reduced-motion, нейтральный покой)
...
- [x] 03-03-PLAN.md — Tracer: состав кейсов (решение) + первый кейс end-to-end (MDX, ProjectCard summary/href, /work из коллекции, /work/{slug}/) + утверждение K1–K4

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03-04-PLAN.md — Контакты: значения (D-12), contacts.json, /contact с копированием email, футер со ссылками
- [x] 03-05-PLAN.md — Страницы контента: /about (4 блока), /lab (2 блока), / (формула D-13 + избранные), check-visual под новые страницы
